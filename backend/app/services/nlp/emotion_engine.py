...
class EmotionEngine:
    ...
    def __init__(self):
        ...
        # Keywords are intentionally specific to avoid false positives on common
        # words like "need", "want", "heart", "always", "never" which appear
        # constantly in non-romantic contexts.
        self.romantic_keywords = {
            'passionate': ['adore', 'passion', 'desire', 'beloved', 'darling'],
            'tender': ['caress', 'tender', 'stroke', 'gently touched', 'tenderly'],
            'longing': ['yearn', 'ache for', 'longing', 'pined', 'yearned'],
            'heartbroken': ['weep', 'sob', 'heartbroken', 'grief-stricken', 'shattered'],
            'breathless': ['breathless', 'gasped', 'breathlessly'],
            'nervous': ['trembling', 'trembled', 'shaking', 'heart pounded', 'heart raced'],
            'romantic': ['romance', 'romantic', 'candlelight', 'moonlight'],
            'sensual': ['kissed', 'embraced', 'melted into', 'lips met'],
        }
